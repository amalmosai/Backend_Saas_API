...
class EventController {
    constructor() {
        ...
        this.getEventById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const event = yield event_model_1.default.findById(eventId).populate("userId", "-password -permissions -_id ");
            if (!event) {
        ...
        this.updateEventById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedEvent = yield event_model_1.default.findByIdAndUpdate({ _id: eventId }, updateData, { new: true });
