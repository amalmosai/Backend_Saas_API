...
function notifyUsersWithPermission(permissionFilter, notificationData) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const notifications = yield notification_model_1.default.insertMany(usersWithPermission.map((user) => (Object.assign(Object.assign({}, notificationData), { recipientId: user._id, status: "sent", isWebDelivered: true }))), { session });
