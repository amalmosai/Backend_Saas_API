...
class AdvertisementController {
    constructor() {
        ...
        this.getAdvertisementById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const advertisement = yield advertisement_model_1.default.findById(id).populate("userId", "-password -permissions -_id ");
            if (!advertisement) {
        ...
        this.updateAdvertisementById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedAdvertisement = yield advertisement_model_1.default.findByIdAndUpdate(id, updateData, { new: true });
