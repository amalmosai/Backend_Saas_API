...
class TransactionController {
    constructor() {
        this.createTransaction = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, notify_1.notifyUsersWithPermission)({ entity: "ماليه", action: "view", value: true }, {
        ...
        this.getTransactionById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const transaction = yield financial_model_1.default.findById(transactionId).populate("createdBy", "-password");
            if (!transaction) {
        ...
        this.updateTransactionById = (0, asynHandler_1.default)((req, res, next) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updatedTransaction = yield financial_model_1.default.findByIdAndUpdate({ _id: transactionId }, updateData, { new: true });
            yield (0, notify_1.notifyUsersWithPermission)({ entity: "ماليه", action: "update", value: true }, {
                sender: { id: req === null || req === void 0 ? void 0 : req.user.id },
